...
const RecurrenteCheckout = { load: loadRecurrenteCheckout };

// Support for different module systems
if (typeof window !== 'undefined') {
  // Browser global
  window.RecurrenteCheckout = RecurrenteCheckout;
}

if (typeof module !== 'undefined' && module.exports) {
  // CommonJS
  module.exports = RecurrenteCheckout;
}

// ES6 module export
export default RecurrenteCheckout;
export { loadRecurrenteCheckout };
